---
title: "All award winners / details"
description: |
  Compiled into a single searchable table
date: "2022-02-17"
...
**Last updated: `r paste0(lubridate::day(lubridate::today()), " ", lubridate::month(lubridate::today(), label = T), " ", lubridate::year(lubridate::today()))`**
...
for(s in seq(1:length(season_reports))){
  ...
  xml_child_number <- ifelse(league == "4545",
                             ...
                             ifelse(league == "LW Open",
                                    ifelse(season %in% c(10, 13, 22, 23, 24),
                                           4,
                                           5),
                                    
                                    ifelse(league == "LW U1800",
                                           ifelse(season %in% c(11, 13, 22, 23, 24),
                                                  4,
                                                  5),
...
# After going through all published reports
...
source(paste0(here::here(), "/scripts/identify_tos_violators.R"))
...
cli::cli_alert_success("Awards search page updated")
```
