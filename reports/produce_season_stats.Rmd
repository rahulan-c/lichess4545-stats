...
pacman::p_load(tidyverse, knitr, rio, kableExtra, gghighlight, data.table,
               ...
               reshape2, utf8, lubridate, tictoc, cowplot, plotly, tippy)
...
if(league == "team4545"){
alt_winners <- alt_award %>% select(player) %>% pull() %>% str_c(collapse = ", ")
alt_value <- alt_award %>% select(teams) %>% pull() %>% unique()
...
awards <- tibble("Image" = c(rep("x", 18)),
                 ...
                 "Details" = c(ifelse(gambiteer_award, paste0(round(gambiteers$success[1] * 100), "% from ", gambiteers$games[1], " games"), "Can't be awarded"),
                              ...
                              ifelse(movetimes_exist, paste0("Had ", dawdlers$time_print[1], " left in ", dawdlers$url[1], " (eventual ", dawdlers$outcome[1], ")"), "Can't be awarded"),
...
#### Time spent, comebacks and upsets {.tabset .tabset-fade .tabset-pills} 
