...
pacman::p_load(tidyverse, knitr, rio, kableExtra, gghighlight, data.table,
               ...
               rvest, ndjson, reshape2, utf8, lubridate, tictoc, cowplot, webshot, 
               tippy, patchwork, magick, ggpubr, grid)

# Remove ggpubr if ggpubr::background_image() isn't used to produce checkmate images
