...
pacman::p_load(tidyverse, knitr, rio, kableExtra, gghighlight, data.table,
               ...
               reshape2, utf8, lubridate, tictoc, cowplot, webshot, tippy)
...
# if(league == "team4545"){team_hide <- TRUE}
```
...
:::first
Winner:
<p style="font-size:32pt; font-weight: 900;">
    `r paste0("[", first, "]", "(", first_link, ")")`
</p>
<p style="font-size:12pt; font-weight: 900;">
    <!-- `r ifelse(league == "team4545", str_c(winners$Gold, collapse = ", "), "")` -->
</p>
:::
...
:::second
Runner up:
<p style="font-size:20pt; font-weight: 600;">
    `r paste0("[", second, "]", "(", second_link, ")")`
</p>
<p style="font-size:12pt; font-weight: 900;">
    <!-- `r ifelse(league == "team4545", str_c(winners$Silver, collapse = ", "), "")` -->
</p>
:::
...
<p style="font-size:12pt; font-weight: 900;">
    <!-- `r ifelse(league == "team4545", str_c(winners$Bronze, collapse = ", "), "")` -->
</p>
:::
...
```{r position_tracker, out.width="85%", fig.align="center"}
...
position_tracker <- positions %>% 
  ...
  gghighlight::gghighlight(team %in% top_places, use_direct_label = T,
                             ...
                             label_params = list(size = 4, 
                                                 ...
                                                 nudge_y = -15, 
                                                 direction = "y",
                                                 fill = c("#b2cefe", "#cd7f32", "#b2cefe", "#c0c0c0", "#ffd700"),
                                                 colour = "black")) +
  labs(x = "Round",
...
### Summary charts {.tabset .tabset-fade .tabset-pills}
...
```{r, out.width = "75%", eval = FALSE, fig.align="center"}

# eval = ifelse(league == "team4545", TRUE, FALSE)
...
### Longest games {.tabset .tabset-fade .tabset-pills}
...
```{r}
webshot::webshot(url = paste0("openings_", ifelse(league_load_label == "team4545", "4545", league_load_label), "_s", season, ".html"), delay = 0.5)

```


<center>
[![Opening star placeholder](images/opening_star_placeholder.png)](`r paste0("openings_", ifelse(league_load_label == "team4545", "4545", league_load_label), "_s", season, ".html")`)
</center>
...
awards <- tibble("Image" = c(rep("x", 18)),
                 ...
                 "Winner" = c(gambiteers$player[1],
                              ...
                              ifelse(movetimes_exist, avg_think_times$player[1], ""),
                 ...
                 "Details" = c(ifelse(gambiteer_award, paste0(round(gambiteers$success[1] * 100), "% from ", gambiteers$games[1], " games"), "Can't be awarded"),
                              ...
                              ifelse(movetimes_exist, paste0(avg_think_times$duration_print[1]), "Can't be awarded"),
                              ...
                              ifelse(movetimes_exist, paste0("Had ", dawdlers$time_print[1], " left after move 10 in ", "[", dawdlers$url[1], "]", "(", dawdlers$url[1], ")", " (eventual ", dawdlers$outcome[1], ")"), "Can't be awarded"),
                              ifelse(movetimes_exist, instamovers$instamoves[1], "Can't be awarded"),
                              ifelse(movetimes_exist, paste0("Spent ", movetimes$time_spent[1], " on ", movetimes$url[1]), "Can't be awarded"),
                 ...
                 "Mentions" = c(ifelse(gambiteer_award, str_c(gambiteers$player[2:3], collapse = ", "), ""),
                              ...
                              "",
                              ifelse(movetimes_exist, str_c(avg_think_times$player[2:3], collapse = ", "), ""),
                              "",
...
awards <- tibble("Image" = c(rep("x", 16)),
                 ...
                 "Details" = c(ifelse(gambiteer_award, paste0(round(gambiteers$success[1] * 100), "% from ", gambiteers$games[1], " games"), "Can't be awarded"),
                              ...
                              paste0("Beat an opponent ", upsets$rating_gap[1], " points higher rated"),
                              paste0(upset_specialists$upsets[1], " upsets (", "biggest: ", upset_specialists$max_rating_gap[1], " pts)"),
                              ifelse(movetimes_exist, paste0("Had ", dawdlers$time_print[1], " left in ", dawdlers$url[1]), "Can't be awarded"),
                              ifelse(movetimes_exist, instamovers$instamoves[1], "Can't be awarded"),
                              ifelse(movetimes_exist, paste0("Spent ", movetimes$time_spent[1], " on ", movetimes$url[1]), "Can't be awarded"),
                              ifelse(movetimes_exist, paste0(round(timetrouble$tt_pc[1]*100, 1), "% (", timetrouble$tt_moves[1], "/", timetrouble$moves[1], ")"), "Can't be awarded"),
                              ifelse(movetimes_exist, paste0(savedbythebell$panic_moves[1], " move(s) in ", savedbythebell$url[1]), "Can't be awarded"),
...
reactable(awards,
          ...
          columns = list(
            ...
            Definition = colDef(show = F),
            Details = colDef(name = "Details", minWidth = 200),
            Mentions = colDef(name = "Honourable mentions", minWidth = 200)
          )
)
...
- Games involving players who were later banned by Lichess for violating their Terms of Service were excluded prior to analysis. This also applies to players who were banned after the season ended.
- Extremely short games of under 5 plies were also excluded, eg https://lichess.org/Cg4Lxjpb. 
- Tournament performance ratings have been calculated using FIDE's preferred method.
- Ties are not properly handled when determining player awards, which may cause errors.
- Other than game points, tiebreaks were not used to determine final player/team rankings for the purpose of the report. Where the top three teams or players had to be determined by tiebreak -- eg 4545 Season 11 -- this is likely to lead to an error in the report.
- Icons for player awards: [Noun Project](https://thenounproject.com/)

```{=html}
&nbsp;
<hr />
<p style="text-align: center;"><a href="https://github.com/rahulan-c/lichess4545-stats">Lichess4545 Statistics</a> (<a href="https://github.com/rahulan-c/lichess4545-stats">source code</a>)</p>
