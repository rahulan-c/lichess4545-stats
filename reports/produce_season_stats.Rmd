...
```{r position_tracker, out.width="75%", fig.align="center"}
...
```{r, out.width = "75%", eval = ifelse(league == "team4545", TRUE, FALSE), fig.align="center"}
...
```{r games_by_day, fig.show="hold", out.width = "50%", fig.align="center"}
...
```{r hists, fig.show="hold", out.width = "50%", fig.align="center"}
...
```{r wins_by_col_by_board, fig.show="hold", out.width = "50%", eval = ifelse(league == "team4545", TRUE, FALSE), fig.align="center"}
