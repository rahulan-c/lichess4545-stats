...
- The stats on this page are presented purely for general interest. They are not guaranteed to be comprehensive, complete, accurate, or up to date. 
- They do not account for games involving players who were banned by Lichess (at any point up to `r format(Sys.time(), '%d %B %Y')`) or games with fewer than 5 plies. 
- Ties are not robustly handled when determining player awards, which may lead to the occasional mistake :)
- Source code: https://github.com/rahulan-c/lichess4545-stats
- Stats homepage: https://rahulan-c.github.io/lichess4545-stats/
- Acknowledgements: [Noun Project](https://thenounproject.com/) (award icons)
:::
