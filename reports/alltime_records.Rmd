...
All-time records will be published here soon. 

While they're under construction, all sorts of strange outputs might appear here.
...
for(s in seq(1:length(season_reports))){
  ...
  print(paste0("Extracting award details for ", league, " S", season, "..."))
...
print("All award data extracted!")
