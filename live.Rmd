...
This page shows "live" standings for currently active leagues. 

These try to account for games that have already been played in the current round. However, they don't account for every tiebreak used in the leagues, so the order of teams or players shown here won't always be accurate. They're also not fully automated yet, so this page might show old or outdated information, and so far I've only produced them for the 4545 league. 
...
Current season/round:  `r paste0("S", season, " R", round)`
