...
status_tbl <- 
  ...
  tab_source_note(
    md(
      "Community leagues: Season 19 of **Series** started on 5 September, as did Season 17 of **Rapid Battle**. Naturally, **Infinite Quest** just keeps going :) Check out the Lichess4545 [overview](https://bit.ly/35w1xqH) for more details."
    )
  )
