...
statuses <- statuses %>% 
  mutate(status = case_when(
    active == TRUE ~ paste0("Mid-season: Season ", season, " will end on ", ends, "."),
    preseason == TRUE ~ paste0("Pre-season: season ", season, " will start on ", starts, "."),
    postseason == TRUE ~ paste0("Post-season: season ", season, " has ended, but registrations for the next season aren't open yet."),
    TRUE ~ NA_character_
  ))
...
status_tbl <- 
  ...
  tab_source_note(
    md(
      "Community leagues: **Infinite Quest** is going strong, **Series** (90+30) is on Season 24 (Dec 2023 - Feb 2024), and the last season of **Rapid Battle** ended in October 2023. To find out more about all our leagues, check out the [Lichess4545 overview](https://bit.ly/35w1xqH)."
    )
  )
