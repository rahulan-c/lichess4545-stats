...
status_tbl <- 
  ...
  tab_source_note(
    md(
      "Community leagues: Series S17 has just ended; S18 will start on 6 June. Rapid Battle S16 ended in Dec 2021; the league is on hiatus. Infinite Quest is still going :) All Lichess4545 leagues and initiatives are listed [here](https://bit.ly/35w1xqH)."
    )
  )
