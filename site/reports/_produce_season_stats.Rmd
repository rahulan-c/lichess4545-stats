...
<p style="font-size:11pt; font-weight: 600;">
    `r paste0(first_score, " (", first_perf, " perf)")`
</p>
:::
...
<p style="font-size:11pt; font-weight: 600;">
  `r paste0(second_score, " (", second_perf, " perf)")`
</p>
:::
...
<p style="font-size:11pt; font-weight: 600;">
  `r paste0(third_score, " (", third_perf, " perf)")`
</p>
:::
...
reactable(marathon_moves,
          ...
          compact = TRUE,
          columns = list(
            rank = colDef(name = "Rank", minWidth = 60),
            player = colDef(name = "Player", minWidth = 200),
...
reactable(timeturners,
          ...
          compact = TRUE,
          columns = list(
            rank = colDef(name = "Rank", minWidth = 80),
            player = colDef(name = "Player", minWidth = 200),
            ids = colDef(show = F),
