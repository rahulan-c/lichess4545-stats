...
The players who made the most moves across the season.
...
Everyone who won or drew at least three games in the season where they ended up gaining time on the clock. Excludes losses and games shorter than 15 moves.
...
reactable(timeturners,
          ...
          columns = list(
            player = colDef(name = "Player", minWidth = 200),
            ids = colDef(show = F),
            games = colDef(name = "Time-gaining games", align = "center", minWidth = 100),
            max_left = colDef(name = "Max time left", align = "center", minWidth = 200),
