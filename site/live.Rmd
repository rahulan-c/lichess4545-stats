...
updated <- paste0(
  ...
  " on ",
  lubridate::wday(lubridate::now(), label = T, week_start = 1),
  " ",
  lubridate::month(lubridate::now(), label = T),
  " ",
...
Latest published `r paste0("S", season)` standings after `r paste0("Round ", round)`: `r paste0("https://www.lichess4545.com/team4545/season/", season, "/standings/")`

Live standings last updated at `r paste0(updated)`.
