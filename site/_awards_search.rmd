...
for(s in seq(1:length(season_reports))){ 
  ...
  xml_child_number <- ifelse(league == "4545",
                             ...
                             ifelse(league == "LW Open",
                                    ifelse(season %in% c(10, 13, 21, 22, 23, 24, 25, 26, 27), 4, 5),
                                    
                                    ifelse(league == "LW U1800",
                                            ifelse(season %in% c(11, 13, 22, 23, 24, 25, 26, 27), 4, 5),
  ...
  if(league == "4545"){
    ...
    if(!(season %in% c(12, 30, 31, 32))){x <- 6} else {
      if(season == 12){x <- 8} else {x <- 9}}
