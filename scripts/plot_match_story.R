...
# PlotMatchStory(27, 1,
#                method = "team",
#                details = "Luft Will Find a Way",
#                request_data = T)

## Match with reversed result -----
# WORKING
# PlotMatchStory(17, 5,
#                method = "team",
#                details = "Pawnhub: A second coming",
#                request_data = T)

# ## Match with unplayed forfeit -----
# WORKING
# PlotMatchStory(27, 5,
#                method = "team",
#                details = "Hoosier Daddy and the Last Crusade",
#                request_data = T)

## Match with double forfeit ----
# WORKING
# PlotMatchStory(12, 1,
#                method = "team",
#                details = "Chessperadoes",
#                request_data = T)

# Match with a scheduling draw ---
# WORKING
# PlotMatchStory(27, 5,
#                method = "team",
#                details = "Casperov the Friendly Ghost",
#                request_data = T)

# Match with a cheat-detect ---
# WORKING
# PlotMatchStory(27, 5,
#                method = "team",
#                details = "The Fianchettoed Rooks",
#                request_data = T)
...
# Make plots for all matches in a season
# Necessary?
# TODO


# Make plots for all matches played by a specific team in a season
# TODO