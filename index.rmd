...
- [All time records](https://rahulan-c.github.io/lichess4545-stats/reports/alltime_stats.html) (likely out of date)
...
if(length(completed_960) > 0){
 completed_960 <- completed_960 %>%  
   ...
   str_remove_all("\\.html") %>% 
   sort(decreasing = T) %>% 
   paste0("[Season ", ., "]", "(https://rahulan-c.github.io/lichess4545-stats/reports/stats_960_s", ., ".html)")
}
...
- [Live standings](https://rahulan-c.github.io/lichess4545-stats/live.html) (only 4545 for now...and irregularly updated)
- [Round reports](https://rahulan-c.github.io/lichess4545-stats/current.html) (4545 match summary plots for recent seasons/rounds)